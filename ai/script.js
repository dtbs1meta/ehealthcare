...
const HISTORY_DATA = {
  intro: [
    { isUser: false, text: 'Chào bạn! Mình là eHealth AI. Mình có thể hỗ trợ gợi ý chuyên khoa, giải thích quy trình đặt lịch, số thứ tự và hồ sơ khám bệnh. Lưu ý: mình không thay thế bác sĩ và không tự chẩn đoán bệnh.', files: [], time: '08:00' },
    { isUser: true, text: 'Tôi bị đau đầu và chóng mặt nên khám khoa nào?', files: [], time: '08:01' },
    { isUser: false, text: 'Bạn có thể cân nhắc khám Thần kinh hoặc Nội khoa, tùy mức độ triệu chứng. Nếu đau đầu dữ dội, yếu tay chân, nói khó, ngất hoặc nôn nhiều, nên đi khám sớm.', files: [], time: '08:01' },
  ],
  html: [
    { isUser: true, text: 'Tôi muốn đặt lịch khám thì làm thế nào?', files: [], time: '09:00' },
    { isUser: false, text: 'Bạn vào mục Đăng ký khám, nhập triệu chứng nếu cần, chọn chuyên khoa, chọn bác sĩ, chọn ngày giờ rồi bấm xác nhận. Sau khi đăng ký, hệ thống sẽ cấp số thứ tự để theo dõi.', files: [], time: '09:00' },
  ],
  history: [
    { isUser: true, text: 'Tôi bị đau họng và ho nên chọn chuyên khoa nào?', files: [], time: '10:00' },
    { isUser: false, text: 'Triệu chứng đau họng và ho thường phù hợp với Tai Mũi Họng hoặc Nội khoa. Nếu có sốt cao, khó thở hoặc đau ngực, bạn nên đi khám sớm.', files: [], time: '10:00' },
  ],
};

const SAMPLE_REPLIES = [
  'Mình chưa kết nối được AI backend. Bạn vẫn có thể mô tả triệu chứng, hệ thống sẽ gợi ý khi AI backend chạy lại.',
  'AI backend chưa sẵn sàng. Hãy kiểm tra server Python tại http://localhost:8000/status.',
  'Mình không thay thế bác sĩ. Bạn có thể chọn chuyên khoa gần nhất với triệu chứng hoặc liên hệ lễ tân để được hỗ trợ.',
];
...
function loadPreset(key) {
  ...
  currentSession = {
    id: 'preset_' + key,
    title: key === 'intro' ? 'Gợi ý chuyên khoa' : key === 'html' ? 'Cách đặt lịch' : 'Ho và đau họng',
